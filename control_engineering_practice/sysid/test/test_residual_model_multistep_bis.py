...
from idsia_mpc.control_engineering_practice.sysid.models import QuadLSTM, PhysQuadModel, MotorsPhysQuadModel, \
    QuadMultiStepModel, NeuralQuadModel
...
mode = "residual"     # "physics", "neural", or "residual"
...
test_dataset = combine_concat_dataset(ConcatDataset(test_ds), scale=True, fold="test", scaler_dir="/home/rbusetto/nanodrone-sysid-mpc/idsia_mpc/control_engineering_practice/sysid/train/scalers")
