...
from idsia_mpc.control_engineering_practice.sysid.models import NeuralQuadModel
...
model = NeuralQuadModel(dt).to(device)

# === Load model ===
try:
    model_path = f"../out/models/neural_quad_model_onestep_{data_type}_{traj_type_train}_{traj_id_train}.pt"
...
out_dir = f"../out/predictions/{data_type}/neural_model_onestep"
